...
var period_index: int = 0  # 0:早,1:上午课,2:午饭,3:下午,4:放学,5:晚自习,6:夜间

var periods = ["morning", "class1", "lunch", "class2", "after_school", "evening", "night"]
...
· 在 GameState 中添加 action_points，每个时段开始重置为固定值，交互消耗点数，点数为零时只能推进时间。
